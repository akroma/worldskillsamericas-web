...
<div class="xcrud-top-actions">
    <?php if($mode == 'edit'){ ?>
    <a class="xcrud-save xcrud-action-button btn btn-primary" data-primary="<?php echo $this->primary_key?>" data-after="edit" href="javascript:void(0);"><?php echo $this->lang('save')?></a>
    <?php }else{ ?>
    <a class="xcrud-save-new xcrud-action-button btn btn-primary" data-primary="<?php echo $this->primary_key?>" data-after="create" href="javascript:void(0);"><?php echo $this->lang('save_new')?></a>
    <a class="xcrud-save-edit xcrud-action-button btn btn-inverse" data-primary="<?php echo $this->primary_key?>" data-after="edit" href="javascript:void(0);"><?php echo $this->lang('save_edit')?></a>
    <?php } ?>
    <a class="xcrud-save-return xcrud-action-button btn btn-success" data-primary="<?php echo $this->primary_key?>" data-after="list" href="javascript:void(0);"><?php echo $this->lang('save_return')?></a>
    <a class="xcrud-return xcrud-action-button btn btn-warning" href="javascript:void(0);"><?php echo $this->lang('return')?></a>
</div>
...
if ($fields)
{ ?>
    <table class="xcrud-details table table-striped">
        <?php
